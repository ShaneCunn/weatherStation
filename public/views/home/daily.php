            ...
            <div class="ct-chart">
                <script>
                    new Chartist.Line('.ct-chart', {
                        labels: [<?php foreach($data['weather_forecast']['daily'] as $forecast): ?>'<?=$lang[$forecast['day']]?>',<?php endforeach ?>],
                        series: [
                            [<?php foreach($data['weather_forecast']['daily'] as $forecast): ?>'<?=$forecast['temp']['max']?>',<?php endforeach ?>],
                            [<?php foreach($data['weather_forecast']['daily'] as $forecast): ?>'<?=$forecast['temp']['min']?>',<?php endforeach ?>]
                        ]
                    }, {
                        axisY: {
